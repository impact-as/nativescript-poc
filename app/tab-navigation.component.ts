...
@Component({
    ...
    template:`
        <FlexboxLayout backgroundColor="black" flexDirection="row" justifyContent="space-around">
            <Image class="tab-icon" src="~/images/home.png" width="30" height="30" nsRouterLink="/home" nsRouterLinkActive="active-link" [nsRouterLinkActiveOptions]="{exact: true}"></Image>
